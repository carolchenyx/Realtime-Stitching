...
leftStream = FileVideoStream("1.avi").start()
rightStream = FileVideoStream("0.avi").start()
time.sleep(2.0)
...
while True:
	...
	# left = cut_image(left, bottom=100, top=100, left=0, right=0)
	# right = cut_image(right, bottom=100, top=100, left=0, right=0)
